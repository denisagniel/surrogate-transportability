#!/bin/bash
# =============================================================================
# submit.sh -- submit the "a5-elbow-validation" study as chunked, throttled SLURM arrays
# =============================================================================
...
#   5. Throttles so no more than MAX_CONCURRENT_JOBS are queued at once,
...
Rscript -e "sd<-'${STUDY_DIR}'; \
  files<-c('config/grid.R','R/dgp_smooth.R','R/pseudo_outcome.R','R/bilinear_estimator.R','R/run_one_stage1.R'); \
