# Writing Modern Tidyverse R Code

*Modern tidyverse patterns for R 4.3+ and dplyr 1.1+*

## Core Principles

1. **Use modern tidyverse patterns** - Prioritize dplyr 1.1+ features, native pipe, current APIs
2. **Write readable code first** - Optimize only when necessary and after profiling
...
### Vectorization and Type Stability
```r
...
map_lgl(data, is.na)   # always returns logical
