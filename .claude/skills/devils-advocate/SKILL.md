...
argument-hint: "[target file or topic description]"
...
1. **Read the target file** (the slide deck or document being challenged)
2. **Read the knowledge base** in `.claude/rules/` for notation conventions and narrative arc
3. If applicable, **read adjacent sections or related files** for narrative continuity
