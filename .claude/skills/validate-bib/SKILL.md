---
name: validate-bib
description: Validate bibliography entries against citations in project files (slides and manuscripts). Find missing entries and unused references.
...
Cross-reference all citations in project files (slides and manuscripts) against bibliography entries.

## Steps

1. **Read the bibliography file** and extract all citation keys

2. **Scan project files for citation keys:**
...
3. **Cross-reference:**
   - **Missing entries:** Citations used in project files but NOT in bibliography
