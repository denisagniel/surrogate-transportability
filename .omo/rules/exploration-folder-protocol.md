...
<!-- GENERATED from .claude/rules/exploration-folder-protocol.md by scripts/generate-omo-rules.sh — DO NOT EDIT -->
...
│   ├── output/            # Results
│   └── SESSION_LOG.md     # Progress notes (for full projects use project-root session_notes/ per session-notes.md)
└── ARCHIVE/
    ├── completed_[project]/
    └── abandoned_[project]/
```
...
- [ ] Quality score >= 80
- [ ] All tests pass
- [ ] Results replicate within tolerance (use tolerance thresholds in [quality-gates.md](quality-gates.md) when checking replication)
