...
<!-- GENERATED from .claude/rules/preprint-protocol.md by scripts/generate-omo-rules.sh — DO NOT EDIT -->
...
**When this protocol applies:** Use this protocol when the project will post a preprint—i.e. when it’s a methods paper, or an applied full paper by explicit decision; never for partial responsibility. Ensure the project satisfies the “paper done” criteria defined in [templates/project-types/paper-done-checklist.md](../../templates/project-types/paper-done-checklist.md) — that checklist is the authority — before completing the steps below. Use this checklist when preparing a paper for preprint.
...
- [ ] **Claims:** Wording matches strength of evidence; limitations stated; no causal language without assumptions nearby (Constitution invariant #12).
