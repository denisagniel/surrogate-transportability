...
\begin{itemize}
    ...
    enough: with H\"older/Sobolev smoothness $s_S,s_Y$, the condition is
    $s_S+s_Y>d/2$ (reducing to $s>d/4$ under equal smoothness). Below this
    ...
    On a finite covariate space the condition holds automatically.
\end{itemize}
